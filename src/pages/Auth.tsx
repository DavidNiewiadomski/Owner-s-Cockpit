    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Construction Management Platform</p>
        </div>
          ...
          <CardContent>
            <Tabs defaultValue="signin" className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-white/10 border border-white/20 mb-6">
                <TabsTrigger 
                  value="signin" 
                  className="data-[state=active]:bg-orange-500 data-[state=active]:text-white text-slate-300 font-medium"
                >
                  Sign In
                </TabsTrigger>
                <TabsTrigger 
                ...
                <form onSubmit={handleSignIn} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className="bg-white/10 border-white/20 text-white placeholder:text-slate-400 focus:border-orange-500 focus:ring-orange-500/20 h-12"
                    />
                  </div>
                  <div className="space-y-2">
